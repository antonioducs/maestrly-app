 ...
 * chat context/cost meter. GET https://models.dev/api.json, cached in memory for 24 hours; the
 * parser itself lives in @maestrly/chat-ui so the Bot reads the same catalogue the same way.
 * Degrades gracefully: chat still works without metadata offline.
 */
import { net } from 'electron'
import type { ChatModelMeta } from '../../shared/chat'
import { parseCatalog, providerModelKey } from '@maestrly/chat-ui/model-meta'
