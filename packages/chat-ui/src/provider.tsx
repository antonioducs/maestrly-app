...
export interface ChatUiLabels {
  ...
  tool: { running: string; done: string; error: string; output: string; command: string; changes: string }
...
export interface ChatUiContextValue {
  ...
  /** Resolves bytes for an image reference the transcript carries; undefined = not available in this app. */
